...
(function ($) {
    ...
    $.fn.idleTimeout = function (userRuntimeConfig) {
        ...
        var defaultConfig = {
            ...
            useCustomPopup : false, //set it to true if you would like to override default popup
            onPopupRequired: function() {
                
            }, //will be fired before popup should be displayed.
            onDialogTimerTicked: function(mins,secs) {
        ...
        //##############################
          ...
          openWarningDialog, dialogTimer, checkDialogTimeout, startDialogTimer, stopDialogTimer, isDialogOpen, destroyWarningDialog, countdownDisplay, isDialogDisplayed, // warning dialog
          logoutUser,
        ...
        openWarningDialog = function () {
            ...
            defaultConfig.onPopupRequired();
            if (!defaultConfig.useCustomPopup) {
        ...
        countdownDisplay = function () {
            ...
            remainingTimer = setInterval(function () {
                ...
                currentConfig.onDialogTimerTicked(mins, secs);
